...
//
//  NO hace:
//    · Lógica de negocio (delegada a cursosService)
//    · Acceso a la base de datos (delegado a cursosRepository)
 ...
 * @param {string}                         [req.query.nombre]          - Filtro parcial por nombre (ILIKE)
 * @param {string}                         [req.query.id_curso_estado] - Filtro exacto por estado (1-3)
 * @param {import('express').Response}     res                         - Express response
 * @param {import('express').NextFunction} next                        - Pasa errores al errorHandler
 * @returns {Promise<void>} 200 { success: true, data: CursoDTO[], pagination: object }
 */
 ...
 * @param {import('express').Response}     res           - Express response
 * @param {import('express').NextFunction} next          - Pasa errores al errorHandler
 * @returns {Promise<void>} 200 { success: true, data: CursoDTO }
 */
 ...
 * @param {import('express').Response}     res       - Express response
 * @param {import('express').NextFunction} next      - Pasa errores al errorHandler
 * @returns {Promise<void>} 201 { success: true, data: CursoDTO }
 */
